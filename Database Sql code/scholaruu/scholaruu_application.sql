...
CREATE TABLE `application` (
  ...
  KEY `fk_ScholarID` (`scholarship_id`),
  KEY `fk_studentID` (`student_id`),
  CONSTRAINT `fk_ScholarID` FOREIGN KEY (`scholarship_id`) REFERENCES `scholarship` (`scholarship_id`),
...
-- Dump completed on 2024-10-28 23:18:09
